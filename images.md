...
:::{tip} Avoid images of text
Avoid using images of text (e.g., a screenshot of a text paragraph) to convey information.
...
Upload the image to an AI chatbot (e.g., ChatGPT, Microsoft Copilot).
Note that the image should *not* contain sensitive or private information.
Then, give the AI chatbot a prompt like the following:
