...
:::{note}
If you have installed TeX Live in a root directory that requires administrator privileges, you may need to run the command with administrator privileges (on Linux, you can add `sudo` before the command).
:::
